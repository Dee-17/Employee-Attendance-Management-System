        ...
        <div class="w-50 card rounded-4 container shadow-lg m-0 p-0 overflow-hidden">
            <div class="row container-fluid m-0 p-0">
                ...
                <div class="left_panel m-0 p-5 col col-6">
                    <div class="py-5 m-0">
                        <img class="mb-4" src="images/company-logo.png" alt="C597 Corporation Logo">
                ...
                <div class="right_panel m-0 py-5 col col-6 d-flex justify-content-center align-items-center">
                    <div class="my-5 mx-3 p-4 text-center justify-content-center container-fluid">
                        ...
                        <div class="button_group container mt-3">
                            <a class="admin_button" href="admin-login.php"><button class="btn btn-primary w-100 p-2">I am an <span class="bold_title">Admin</span></button></a>
                            <a class="emp_button" href="employee-login.php"><button class="btn btn-light w-100 mt-2 p-2">I am an <span class="bold_title">Employee</span></button></a>
                        </div>
                    </div>
                </div>
            </div>
