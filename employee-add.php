<?php
    ...
    if ((!$first_name) || (!$middle_name) || (!$last_name) || (!$address) || (!$zip) || (!$contact_number) || (!$email_address) || (!$contract) || (!$shift)) {
        ...
        $sql = "INSERT INTO employee (first_name, middle_name, last_name, address, zip, contact_number, email_address, contract, shift) 
        VALUES ('$first_name', '$middle_name', '$last_name', '$address', '$zip', '$contact_number', '$email_address', '$contract', '$shift')";
