<?php
    ...
    if (isset($_GET['emp_id'])) {
        ...
        // Prepare a SQL DELETE statement for the atlog table
        $sql = "DELETE FROM atlog WHERE emp_id = ?";
        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                // Records deleted successfully from atlog table. Now delete from employee table.
